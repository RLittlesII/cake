...
{
    /// <summary>
    /// Provides TravisCI repository information for the current build.
    /// </summary>
    public class TravisCIRepositoryInfo : TravisCIInfo
    {
        /// <summary>
        ...
        public TravisCIRepositoryInfo(ICakeEnvironment environment) : base(environment)
        {
        }
    }
}
